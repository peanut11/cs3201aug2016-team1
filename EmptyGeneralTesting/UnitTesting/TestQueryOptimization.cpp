	...
	TEST_CLASS(TestQueryOptimization) {
		...
		*/
		...
		TEST_METHOD(TestQueryOptimization_Query) {
			...
			std::string declaration = "procedure p, q;variable v,v1, v2, v3;assign a,a1, a2, a3;if ifstmt,ifs;while w;stmt s1, s2, s3, s4, s5;progline n1, n2;call c;constant const;\n";
